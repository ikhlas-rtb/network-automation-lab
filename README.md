...
# Wait ~15 seconds for OSPF/BGP convergence, then run the monitor
python scripts/network_monitor.py

# Open the generated report
start report.html  # or `open report.html` on macOS
```
...
Once the topology is up, you can validate routing manually:
...
The Python monitor produces both a terminal summary and an HTML report:Network Status Summary
+-------------------------------------+
...
The HTML report is in `docs/sample-report.html`.
